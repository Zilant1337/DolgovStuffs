...
yDegrees=15
zDegrees=10
transaltionVector=np.matrix([[-2],[3],[-2]])
scale=0.8

rotationMatrix= np.matmul(np.matmul(np.matrix([[1,0,0],[0,math.cos(math.radians(xDegrees)),-1*math.sin(math.radians(xDegrees))],[0,math.sin(math.radians(xDegrees)),math.cos(math.radians(xDegrees))]]),
                          np.matrix([[math.cos(math.radians(yDegrees)),0,math.sin(math.radians(yDegrees))],[0,1,0],[-1*math.sin(math.radians(yDegrees)),0,math.cos(math.radians(yDegrees))]])),
                          np.matrix([[math.cos(math.radians(zDegrees)),-1*math.sin(math.radians(zDegrees)),0],[math.sin(math.radians(zDegrees)),math.cos(math.radians(zDegrees)),0],[0,0,1]]))
translationMatrix= np.matrix([[1,0,0,transaltionVector[0,0]],[0,1,0,transaltionVector[1,0]],[0,0,1,transaltionVector[2,0]],[0,0,0,1]])
scalingMatrix = np.matrix([[scale,0,0,0],[0,scale,0,0],[0,0,scale,0],[0,0,0,1]])
Mo2w=np.matmul(translationMatrix,scalingMatrix)
